...
// The site to crawl.
const BASE_URL = "https://docs.spring.io/spring-boot/docs/current/reference/htmlsingle/"
const DEBUG = false;
...
function withLinks(linksLoadedCallback) {
    ...
    currentRequest = loadSinglePage(function (html) {
        console.error("html loaded, extracting links...");
        loadedLinks = extractLinks(html);
        console.error(loadedLinks.length, "links loaded !");
        linksLoadedCallback(loadedLinks);
    });
}
